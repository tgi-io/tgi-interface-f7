/**---------------------------------------------------------------------------------------------------------------------
 * tgi-interface-f7/lib/tgi-interface-f7.source.js
 */
/**
 * Constructor
 */
var F7Interface = function (args) {
  if (false === (this instanceof Interface)) throw new Error('new operator required');
  args = args || {};
  args.name = args.name || '(unnamed)';
  args.description = args.description || 'a F7Interface';
  var i;
...
F7Interface.prototype = Object.create(Interface.prototype);
/**
 * Methods
 */
